...
function Product({ product }) {
  ...
  return (
    <>
      ...
      />
      <div>
        <p className="mt-4 text-gray-600 text-left ml-4 font-bold font-sans text-lg">
          {product.title}
        </p>
        <p className="ml-4 mt-4 text-left truncate text-sm text-gray-400 italic">
          {product.description}
        </p>
        <p className="mt-4 ml-4 mb-4 text-gray-600 text-left font-bold font-sans text-lg">
        ...
        <button
          ...
          className="mt-4 ml-4 mb-4 text-xs mr-2 px-4 py-3 bg-red-600 hover:bg-red-800 rounded-md text-white outline-none focus:ring-4 shadow-lg transform transition-transform flex"
        >
          <svg
            width="13px"
            height="13px"
        ...
        {/* <div className="flex justify-between mb-6">
          <button
            type="button"
            className="ml-2 px-4 py-3 bg-blue-600 hover:bg-blue-800 rounded-md text-white outline-none focus:ring-4 shadow-lg transform transition-transform flex"
          >
            <svg
              width="20px"
              height="20px"
          ...
          <button
            ...
            className="mr-2 px-4 py-3 bg-red-600 hover:bg-red-800 rounded-md text-white outline-none focus:ring-4 shadow-lg transform transition-transform flex"
          >
            <svg
              width="20px"
              height="20px"
